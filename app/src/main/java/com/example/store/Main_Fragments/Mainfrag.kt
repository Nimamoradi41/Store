...
//        var W=dis.widthPixels
        ...
        if (data.products!=null)
        {
            ...
            ad_Spa_1= adapter_Spacial(activity!!,data)
            V?.rootView?.recy_special_2?.layoutManager=LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,true)
    ...
    private fun Setdiscounts( c:discounts) {
        ...
        if (c.products!=null)
        {
            ...
            ad_dis= Adapter_discounts(activity!!,c)
            V?.rootView?.recy_discounts?.layoutManager=LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,true)
    ...
    private fun SetproductBoxDtos( c:ArrayList<productBoxDtos>) {
        ...
        if (c.size!=null)
        {
            ...
            ad_productBoxDtos_= Adapter_productBoxDtos(activity!!,c)
...
//                 MainActivity.transaction?.beginTransaction()?.add(R.id.Cont,f)?.addToBackStack(null)?.commit()
            ...
            V?.rootView?.recy_category?.layoutManager=LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,true)
